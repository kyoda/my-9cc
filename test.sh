...
assert 3 "int main() { int a; int i; a = 0; for (i=0; i<3; i=i+1) {a = a + i;} return a; }"
assert 0 "int main() { int a;a = 0; for (;;) {return a;} }"
...
assert 25 "int main() { int i;int j;i = 20; j = &i; return *j + 5;}"
